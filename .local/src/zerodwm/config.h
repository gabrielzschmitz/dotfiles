...
static const char *fonts[] = {
    "iMWritingMono Nerd Font:size=10:antialias=true:autohint=true"};
...
static const char *changewallcmd[] = {
    "randomwall", "/home/gabrielzschmitz/pic/wall/catppuccin", NULL};
static const char *passdmenucmd[] = {"passdmenu", NULL};
static const char *filescmd[] = {TERMINAL, "-c", "sfm", "-g",
                                 "100x30", "-e", "sfm", NULL};
...
static const char *webcmd[] = {"thorium-browser", NULL};
static const char *touchpadswitchcmd[] = {"touchpadswitch", NULL};
...
static const char *audiocontrolcmd[] = {TERMINAL, "-c", "ncpamixer", "-g",
                                        "80x15",  "-e", "ncpamixer", NULL};
static const char *tomatocmd[] = {TERMINAL, "-c", "Tomato.C", "-g",
                                  "69x34",  "-e", "tomato",   NULL};
static const char *keybcmd[] = {TERMINAL, "-c", "keyb", "-g",
                                "100x30", "-e", "keyb", NULL};
static const char *mutemiccmd[] = {"pamixer", "--default-source",
                                   "--toggle-mute", NULL};

#include <X11/XF86keysym.h>
static const Key keys[] = {
    /* modifier                     key        function        argument */
    {Mod1Mask, XK_d, spawn, SHCMD("discordreopen")},
    {Mod1Mask, XK_w, spawn, {.v = changewallcmd}},
    ...
    {Mod1Mask, XK_t, spawn, {.v = touchpadswitchcmd}},
    {MODKEY, XK_F1, spawn,
     SHCMD("groff -mom $HOME/.local/share/dwm/gzdots.mom -T pdf | zathura -")},
    {MODKEY | ShiftMask, XK_b, spawn,
     SHCMD("$HOME/.config/polybar/launch.sh &")},
    ...
    {0, XK_Print, spawn,
     SHCMD("scrot ~/pic/allmon-$(date +%H:%M:%S).png --quality 100 --freeze")},
    ...
    {0, XF86XK_MonBrightnessUp, spawn,
     SHCMD("doas /home/gabrielzschmitz/.local/bin/sunlight")},
    {0, XF86XK_MonBrightnessDown, spawn,
     SHCMD("doas /home/gabrielzschmitz/.local/bin/moonlight")},
};
