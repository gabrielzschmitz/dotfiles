...
/* colors                     fg,  bg */
static const Cpair cdir    = { 4,   0 };
static const Cpair cfile   = { 0,   0 };
static const Cpair clnk    = { 2,   0 };
static const Cpair cblk    = { 5,   0 };
static const Cpair cchr    = { 4,   0 };
static const Cpair cifo    = { 3,   0 };
static const Cpair csock   = { 2,   0 };
static const Cpair cexec   = { 2,   0 };
static const Cpair cother  = { 0,   0 };
                                    
static const Cpair cframe  = { 0,   0 };
static const Cpair cpanell = { 6,   0 };
static const Cpair cpanelr = { 5,   0 };
static const Cpair cerr    = { 1,   0 };
static const Cpair cprompt = {232,  4 };
static const Cpair csearch = { 7,   0 };
static const Cpair cstatus = { 0,   0 };
...
/* software */
static const char *mpv[]        = { "mpv", "--fullscreen", "--loop" };
static const char *nsxiv[]      = { "nsxiv", "-a" };
static const char *zathura[]    = { "zathura" };
static const char *office[]     = { "onlyoffice-desktopeditors" };
static const char *gimp[]       = { "gimp" };
static const char *inkscape[]   = { "inkscape" };
static const char *kdenlive[]   = { "kdenlive" };

/* extensions*/
static const char *images[]    = { "bmp", "jpg", "jpeg", "png", "gif", "webp", "xpm" };
static const char *pdf[]       = { "epub", "pdf" };
static const char *arts[]      = { "xcf" };
static const char *vectorarts[]= { "svg" };
static const char *videoedits[]= { "kdenlive" };
...
static Rule rules[] = {
	...
	{documents,     LEN(documents),     office,     LEN(office)     },
	{arts,          LEN(arts),          gimp,       LEN(gimp)       },
	{vectorarts,    LEN(vectorarts),    inkscape,   LEN(inkscape)   },
	{videoedits,    LEN(videoedits),    kdenlive,   LEN(kdenlive)   },
};
...
/* unicode chars - 0 mean borderless*/
#define u_hl  0x0 /* ─ */
#define u_vl  0x0 /* │ */
#define u_cnw 0x0 /* ┌ */
#define u_cne 0x0 /* ┐ */
