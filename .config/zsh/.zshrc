...
alias vimwiki='nvim $HOME/Documents/Wiki/index.wiki'
alias vimwikidiary='nvim $HOME/Documents/Wiki/Diary/diary.wiki'
alias zshrc='nvim $HOME/.config/zsh/.zshrc'
alias sourcezshrc='source .config/zsh/.zshrc'
alias colors='nvim .scripts/faintcolorscheme.vim'
