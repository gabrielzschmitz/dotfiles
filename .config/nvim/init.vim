...
nnoremap <space> za " Open and closes folds
" }}}
...
"  NeoVim Config {{{
let mapleader=","
let $MYNVIMCONFIG = "~/.config/nvim/init.vim"
nnoremap <leader>ev :edit $MYNVIMCONFIG <CR>
nnoremap <leader>sv :source $MYNVIMCONFIG <bar> :doautocmd BufRead<CR>
" }}}
