...
local function set_hlgroups()
    ...
    local function load_plugin(plugin)
        ...
        hlgroups = vim.tbl_deep_extend("force", hlgroups, require("zeropro.plugins." .. plugin).get(theme))
    end
...
function M.setup_theme(name)
    theme.config = require("zeropro.config").config
    theme.colors = require("zeropro.colors").get_theme_colors(name)
